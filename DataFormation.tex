...
The raw intensity HH, HV and VV bands were first equalized independently, and the assigned to the red, green and blue channels.

\begin{figure*}
\centering
\includegraphics[width=\linewidth]{ESAR_RGB}
...
We selected $15561$ positions within the dark area in the upper part of the image, and extracted the observations in the intensity channels (without equalization).
