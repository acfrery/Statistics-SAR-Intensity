...
X-band			& \SIrange{12.5}{8}{\GHz}	& \SIrange{2.4}{3.75}{\cm} \\
C-band			& \SIrange{8}{4}{\GHz} 			& \SIrange{3.75}{7.5}{\cm}\\
S-band			& \SIrange{4}{2}{\GHz}	& \SIrange{7.5}{15}{\cm} \\
L-band			& \SIrange{2}{1}{\GHz}	& \SIrange{15}{30}{\cm} \\
P-band			& \SIrange{0.999}{0.2998}{\GHz}	& \SIrange{30}{100}{\cm} \\
\bottomrule
\end{tabular}
\end{table}
