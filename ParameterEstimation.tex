...
This code run in approximately \SI{3}{\hour}~\SI{20}{\minute}
...
\begin{figure*}
\centering
\includegraphics[width=.45\linewidth]{BiasMonteCarlo}
\includegraphics[width=.45\linewidth]{MSEMonteCarlo}
