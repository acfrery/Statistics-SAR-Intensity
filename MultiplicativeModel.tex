...
\caption[Densities in linear and semilogarithmic scale of the $\text{E}(1)$ (green) and $\mathcal G^0$ distributions with unitary mean]{Densities in linear and semilogarithmic scale of the $\text{E}(1)$ (green) and $\mathcal G^0$ distributions with unitary mean ($\alpha\in\{-1.5,-3,-8\}$ in red, blue, and black, resp.)}\label{Fig:GI0Distribution}
\end{figure}
...
\citet{IGARSSChan2017} discuss other techniques for obtaining such deviates.

\section{The KummerU distribution}
